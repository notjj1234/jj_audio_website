...
**Memory spike** (arm64, `htdemucs_6s` + `quality=fast`, synthetic tones): peak RSS was ~2 GiB for ≤120 s in that run — **PASS** for short clips, not a promise for dense mixes or many parallel jobs.
