.PHONY: install install-demucs fixtures test eval eval-lead-rhythm backend ui pipeline mixer-build help _check_python preflight tester desktop-bundle-ffmpeg desktop-build desktop-app desktop-pkg desktop-dmg
